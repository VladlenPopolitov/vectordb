...
createfile("../../vectordata/galaxies-16-1000000-e.hdf5","l2");
...
while (my @row = $sth->fetchrow_array()) {
     ...
     if(defined($x1)){
            ...
            $x1=$x1->glue(1,pdl(float,[ [ ${$row[1]}[0],${$row[1]}[1],${$row[1]}[2],${$row[1]}[3] ,${$row[1]}[4] ,${$row[1]}[5] ,${$row[1]}[6] 
            ,${$row[1]}[7] ,${$row[1]}[8] ,${$row[1]}[9] ,${$row[1]}[10] ,${$row[1]}[11] ,${$row[1]}[12] ,${$row[1]}[13] 
            ,${$row[1]}[14] ,${$row[1]}[15]  ]])); 
     } else {
          $x1=pdl(float, [ [ ${$row[1]}[0],${$row[1]}[1],${$row[1]}[2],${$row[1]}[3] ,${$row[1]}[4] ,${$row[1]}[5] ,${$row[1]}[6] 
            ,${$row[1]}[7] ,${$row[1]}[8] ,${$row[1]}[9] ,${$row[1]}[10] ,${$row[1]}[11] ,${$row[1]}[12] ,${$row[1]}[13] 
            ,${$row[1]}[14] ,${$row[1]}[15]  ]]);      
